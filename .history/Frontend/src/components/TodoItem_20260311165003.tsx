...
export default function TodoItem({todo,onDelete,onToggle,onUpdate}:Props){
  ...
  return(
    <div className="p-4 bg-white rounded-lg shadow hover:shadow-md mb-3 border-l-4"
      + ` ${todo.priority === 'high' ? 'border-red-500' : todo.priority === 'medium' ? 'border-yellow-500' : 'border-green-500'}`
      >
